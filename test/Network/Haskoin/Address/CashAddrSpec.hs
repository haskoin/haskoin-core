...
spec = do
  ...
  describe "cashAddress larger test vectors" $ do
    it "cashAddr test vector 1" (testCashAddr $ head vectors)
    it "cashAddr test vector 2" (testCashAddr $ vectors !! 1)
    it "cashAddr test vector 3" (testCashAddr $ vectors !! 2)
    it "cashAddr test vector 4" (testCashAddr $ vectors !! 3)
    it "cashAddr test vector 5" (testCashAddr $ vectors !! 4)
    it "cashAddr test vector 6" (testCashAddr $ vectors !! 5)
    it "cashAddr test vector 7" (testCashAddr $ vectors !! 6)
    it "cashAddr test vector 8" (testCashAddr $ vectors !! 7)
    it "cashAddr test vector 9" (testCashAddr $ vectors !! 8)
    it "cashAddr test vector 10" (testCashAddr $ vectors !! 9)
    it "cashAddr test vector 11" (testCashAddr $ vectors !! 10)
    it "cashAddr test vector 12" (testCashAddr $ vectors !! 11)
    it "cashAddr test vector 13" (testCashAddr $ vectors !! 12)
    it "cashAddr test vector 14" (testCashAddr $ vectors !! 13)
    it "cashAddr test vector 15" (testCashAddr $ vectors !! 14)
    it "cashAddr test vector 16" (testCashAddr $ vectors !! 15)
    it "cashAddr test vector 17" (testCashAddr $ vectors !! 16)
    it "cashAddr test vector 18" (testCashAddr $ vectors !! 17)
    it "cashAddr test vector 19" (testCashAddr $ vectors !! 18)
    it "cashAddr test vector 20" (testCashAddr $ vectors !! 19)
    it "cashAddr test vector 21" (testCashAddr $ vectors !! 20)
    it "cashAddr test vector 22" (testCashAddr $ vectors !! 21)
    it "cashAddr test vector 23" (testCashAddr $ vectors !! 22)
    it "cashAddr test vector 24" (testCashAddr $ vectors !! 23)
    it "cashAddr test vector 25" (testCashAddr $ vectors !! 24)
    it "cashAddr test vector 26" (testCashAddr $ vectors !! 25)
    it "cashAddr test vector 27" (testCashAddr $ vectors !! 26)
    it "cashAddr test vector 28" (testCashAddr $ vectors !! 27)
    it "cashAddr test vector 29" (testCashAddr $ vectors !! 28)
    it "cashAddr test vector 30" (testCashAddr $ vectors !! 29)
    it "cashAddr test vector 31" (testCashAddr $ vectors !! 30)
    it "cashAddr test vector 32" (testCashAddr $ vectors !! 31)
...
testCashAddr (len, typ, addr, hex) = do
  ...
  where
    Just bs = decodeHex $ pack hex
    Just (pfx, ver, pay) = cash32decodeType $ pack addr

vectors :: [(Int, Int, String, String)]
vectors =
